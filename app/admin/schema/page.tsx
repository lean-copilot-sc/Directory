...
export default function SchemaPage() {
    const { schema, updateSchema, user } = useDirectory();
        ...
        return (
            <div className="min-h-screen bg-background flex flex-col items-center justify-center text-center p-4">
                ...
                <p className="text-muted max-w-md mb-8 z-10">
                    Only Administrators can configure the schema.
                </p>
                <div className="z-10">
    ...
    const handleSave = (newSchema: Field[]) => {
        ...
        alert("Schema Configuration Saved from Context!");
    };
            ...
            <div className="relative z-10">
                ...
                <main className="container mx-auto px-4 py-8">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-10 border-b border-border pb-6">
                        <div>
                            <h1 className="text-3xl font-serif text-white tracking-wide">Schema Builder</h1>
